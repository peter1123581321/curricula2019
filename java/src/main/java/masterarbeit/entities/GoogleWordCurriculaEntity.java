...
@Entity
@Table(name = "googlewordcurricula")
public class GoogleWordCurriculaEntity extends AbstractGoogleWordEntity {
	...
	@JoinColumn(name="curricula")
	private CurriculaEntity curriculaId;
...
//	private GoogleWordUniqueEntity googleWordUniqueEntity;
	...
	public CurriculaEntity getCurriculaId() {
		return curriculaId;
	}

	public void setCurriculaId(CurriculaEntity curriculaId) {
