...
--
-- Table structure for table `auswertung_curriculum2curriculum`
--

DROP TABLE IF EXISTS `auswertung_curriculum2curriculum`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `auswertung_curriculum2curriculum` (
  `curriculum1` varchar(10) DEFAULT NULL,
  `curriculum2` varchar(10) DEFAULT NULL,
...
-- Dump completed on 2019-09-13 16:41:59
